<template>
    <div class="about-container" :style="lightEffect">
        <div class="about-content">
            ...
            <p>
                ...
                <span>React</span>（工作中会使用到）、 <span>Kettle</span>（一个优秀的ETL工具！！工作中重度使用此工具！不过比较小众，就放在后面吧！）
            </p>
            <p>
                我的爱好有<span>摄影</span>（尼康佬在此！曾去钟楼找模特拍照，作为社恐的我来说，真的算是突破自我了！）、
                <span>徒步</span
                >（可以帮我从疲劳中快速脱离出来！泉州徒步推荐地点——大坪山、丰海路。非常推荐大家在有空的时候去徒步一下，背上行囊，好好看看那座你生存的城市吧❤️）、
                <span>古玩</span
...
@keyframes changeColor {
    0% {
        color: rgb(255, 166, 0); /* 橙色 */
    }
    50% {
        color: rgb(255, 102, 153); /* 粉红色 */
    }
    100% {
        color: rgb(102, 153, 255); /* 浅蓝色 */
    }
}
</style>
